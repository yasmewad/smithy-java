...
final class ClientInterceptorChain implements ClientInterceptor {
    ...
    public <I extends SerializableShape, RequestT> void readAfterSerialization(
            Context context, I input, Value<RequestT> request) {
        for (var interceptor : interceptors) {
    ...
    public <I extends SerializableShape, RequestT, ResponseT> void readAfterTransmit(
            Context context, I input, Value<RequestT> request, Value<ResponseT> response) {
        for (var interceptor : interceptors) {
    ...
    @Override
    public <I extends SerializableShape, O extends SerializableShape, RequestT, ResponseT> void
    ...
    @Override
    public <I extends SerializableShape, O extends SerializableShape, RequestT, ResponseT> Either<O, SdkException>
    ...
    @Override
    public <I extends SerializableShape, O extends SerializableShape, RequestT, ResponseT>
    void readAfterAttempt(
            Context context,
            I input,
            Value<RequestT> request,
    ...
    modifyBeforeCompletion(
        ...
        for (var interceptor : interceptors) {
            result = interceptor.modifyBeforeCompletion(
                    context, input, requestIfAvailable, responseIfAvailable, result);
        }
        return result;
    }
