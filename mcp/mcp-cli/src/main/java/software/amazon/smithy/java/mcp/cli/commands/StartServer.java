...
public final class StartServer extends SmithyMcpCommand {
    ...
    public void execute(ExecutionContext context) throws IOException {
        ...
        if (proxyServer != null) {
            ...
            // Pass promptsPath to the builder even if it's null
            // The McpServer will handle null paths by logging an error and continuing
            builder.promptsPath(promptsPath);
